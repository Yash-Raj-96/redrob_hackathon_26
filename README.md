...
| **Submission CSV** | `outputs/final_candidates.csv` |
...
| Name | Role |
|------|------|
| **YASHVANTH P S** | Team Lead / Software Development Engineer |

---

## 📄 License

This project is developed for the **Redrob Hackathon - Intelligent Candidate Discovery & Ranking Challenge**.
...
- Hack2Skill for the challenge platform
- Hugging Face for hosting the Space

---

**"Ranking intelligence that understands the job, not just the keywords."** 🚀
```
...
| Section | Description |
|---------|-------------|
| ✅ Live Demo | Hugging Face Spaces links |
| ✅ Key Features | Hard filtering, tiered scoring, reasoning, dashboard |
| ✅ Scoring Components | Skill (55%), Career (30%), Behavior (15%) |
| ✅ Project Structure | Complete directory tree |
| ✅ Run Guide | Step-by-step setup and execution |
| ✅ Validation | How to validate submission |
| ✅ Sandbox | Streamlit dashboard instructions |
| ✅ Output Format | CSV structure and example |
| ✅ Docker Deployment | Dockerfile and Hugging Face setup |
| ✅ Quick Commands | One-line run commands |
| ✅ Technologies | Tech stack overview |
| ✅ Submission Assets | GitHub, Sandbox, CSV links |
| ✅ Team | Team member details |

---

**Your `README.md` is now complete and ready for your GitHub repository!** 🚀
